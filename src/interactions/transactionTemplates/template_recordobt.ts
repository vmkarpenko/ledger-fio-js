        ...
        ...COMMANDS_COUNTED_SECTION([
            ...
            ...COMMANDS_COUNTED_SECTION([
                ...COMMANDS_DH_ENCODE(Buffer.from(actionData.payee_public_key, "hex"), [
                    ...
                    COMMAND_APPEND_DATA_STRING_WITH_LENGTH_SHOW("Status", Buffer.from(actionData.status)),
                    COMMAND_APPEND_DATA_STRING_WITH_LENGTH_SHOW("Obt ID", Buffer.from(actionData.obt_id)),
