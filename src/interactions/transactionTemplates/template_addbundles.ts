import type {HexString, ParsedActionAuthorisation, ParsedBuyBundledTransaction, ParsedMapBlockchainPublicAddress, ParsedRemoveAllMappedAddresses, ParsedTransaction, ParsedTransferFIOTokensData, Uint8_t, ValidBIP32Path} from "../../types/internal"
import { Command, VALUE_STORAGE_COMPARE, COMMAND_APPEND_CONST_DATA, COMMAND_SHOW_MESSAGE, COMMANDS_COUNTED_SECTION, COMMAND_STORE_VALUE, 
         ...
         COMMAND_APPEND_DATA_UINT64_SHOW,
...
const CONTRACT_NAME = parseNameString("addbundles", InvalidDataReason.UNEXPECTED_ERROR);


export function template_addbundles(chainId: HexString, tx: ParsedTransaction, parsedPath: ValidBIP32Path): Array<Command> {
    ...
    const actionData: ParsedBuyBundledTransaction = tx.actions[0].data as ParsedBuyBundledTransaction;
    ...
    return [
        ...
        COMMAND_SHOW_MESSAGE("Action", "Add Bundles"),
        ...
        ...COMMANDS_COUNTED_SECTION([
            ...
            COMMAND_APPEND_DATA_UINT64_SHOW("Bundle sets", uint64_to_buf(actionData.bundle_sets).reverse()), 
