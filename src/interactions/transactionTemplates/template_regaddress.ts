...
const CONTRACT_NAME = parseNameString("regaddress", InvalidDataReason.UNEXPECTED_ERROR);


export function template_regaddress(chainId: HexString, tx: ParsedTransaction, parsedPath: ValidBIP32Path): Array<Command> {
    ...
    const actionData: ParsedRegisterAddress = tx.actions[0].data as ParsedRegisterAddress;
    ...
    return [
        ...
        ...COMMANDS_COUNTED_SECTION([
            ...
            ...COMMANDS_COUNTED_SECTION([
                COMMAND_APPEND_DATA_STRING_SHOW("Owner Pubkey", Buffer.from(actionData.owner_fio_public_key))
            ]), 
