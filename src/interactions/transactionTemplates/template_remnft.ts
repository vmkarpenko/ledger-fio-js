import type {HexString, ParsedActionAuthorisation, ParsedMapNFTSignature, ParsedRemoveNFTSignature, ParsedTransaction, Uint8_t, ValidBIP32Path} from "../../types/internal"
