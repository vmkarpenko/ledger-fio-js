import type {HexString, ParsedActionAuthorisation, ParsedTransaction, ParsedTransferAddress, Uint8_t, ValidBIP32Path} from "../../types/internal"
...
export function template_xferaddress(chainId: HexString, tx: ParsedTransaction, parsedPath: ValidBIP32Path): Array<Command> {
    ...
    return [
        ...
        ...COMMANDS_COUNTED_SECTION([
            ...
            COMMAND_APPEND_DATA_STRING_WITH_LENGTH_SHOW("Owner Pubkey", Buffer.from(actionData.new_owner_fio_public_key)),
