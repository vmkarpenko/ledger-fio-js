import type {HexString, ParsedActionAuthorisation, ParsedTransaction, ParsedTransferDomain, ParsedWrapTokens, Uint8_t, ValidBIP32Path} from "../../types/internal"
...
const CONTRACT_NAME = parseNameString("wraptokens", InvalidDataReason.UNEXPECTED_ERROR);


export function template_wraptokens(chainId: HexString, tx: ParsedTransaction, parsedPath: ValidBIP32Path): Array<Command> {
    ...
    const actionData: ParsedWrapTokens = tx.actions[0].data as ParsedWrapTokens;
    ...
    return [
        ...
        COMMAND_SHOW_MESSAGE("Action", "Wrap Tokens"),
