import type {HexString, ParsedActionAuthorisation, ParsedRemoveAllNFT, ParsedTransaction, ParsedTransferDomain, ParsedTransferFIOTokensData, Uint8_t, ValidBIP32Path} from "../../types/internal"
...
export function template_remallnfts(chainId: HexString, tx: ParsedTransaction, parsedPath: ValidBIP32Path): Array<Command> {
    ...
    return [
        ...
        COMMAND_SHOW_MESSAGE("Action", "Remove all nft mappings"),
