...
import { Command, VALUE_STORAGE_COMPARE, COMMAND_APPEND_CONST_DATA, COMMAND_SHOW_MESSAGE, COMMANDS_COUNTED_SECTION, COMMAND_STORE_VALUE, 
         ...
         COMMAND_APPEND_DATA_CHAIN_CODE_CONTRACT_ADDR_TOKEN_TD_SHOW} from "./commands"
...
function template1(chainId: HexString, tx: ParsedTransaction, parsedPath: ValidBIP32Path): Array<Command> {
    ...
    return [
        ...
        ...COMMANDS_COUNTED_SECTION([
            COMMAND_APPEND_DATA_BUFFER_DO_NOT_SHOW(Buffer.from(actionData.nfts[0].url), 0, 128)
        ]),
        ...COMMANDS_COUNTED_SECTION([
            COMMAND_APPEND_DATA_BUFFER_DO_NOT_SHOW(Buffer.from(actionData.nfts[0].hash), 1, 64)
        ]),
        ...COMMANDS_COUNTED_SECTION([
            COMMAND_APPEND_DATA_BUFFER_DO_NOT_SHOW(Buffer.from(actionData.nfts[0].metadata), 0, 128)
        ]),
    ]
}
...
function template2(chainId: HexString, tx: ParsedTransaction, parsedPath: ValidBIP32Path): Array<Command> {
    ...
    return [
        ...
        ...COMMANDS_COUNTED_SECTION([
            COMMAND_APPEND_DATA_BUFFER_DO_NOT_SHOW(Buffer.from(actionData.nfts[1].url), 0, 128)
        ]),
        ...COMMANDS_COUNTED_SECTION([
            COMMAND_APPEND_DATA_BUFFER_DO_NOT_SHOW(Buffer.from(actionData.nfts[1].hash), 1, 64)
        ]),
        ...COMMANDS_COUNTED_SECTION([
            COMMAND_APPEND_DATA_BUFFER_DO_NOT_SHOW(Buffer.from(actionData.nfts[1].metadata), 0, 128)
        ]),
    ]
}
...
function template3(chainId: HexString, tx: ParsedTransaction, parsedPath: ValidBIP32Path): Array<Command> {
    ...
    return [
        ...
        ...COMMANDS_COUNTED_SECTION([
            COMMAND_APPEND_DATA_BUFFER_DO_NOT_SHOW(Buffer.from(actionData.nfts[2].url), 0, 128)
        ]),
        ...COMMANDS_COUNTED_SECTION([
            COMMAND_APPEND_DATA_BUFFER_DO_NOT_SHOW(Buffer.from(actionData.nfts[2].hash), 1, 64)
        ]),
        ...COMMANDS_COUNTED_SECTION([
            COMMAND_APPEND_DATA_BUFFER_DO_NOT_SHOW(Buffer.from(actionData.nfts[2].metadata), 0, 128)
        ]),
    ]
}
