...
const CONTRACT_NAME = parseNameString("stakefio", InvalidDataReason.UNEXPECTED_ERROR);


export function template_stakefio(chainId: HexString, tx: ParsedTransaction, parsedPath: ValidBIP32Path): Array<Command> {
