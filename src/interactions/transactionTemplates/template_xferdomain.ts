import type {HexString, ParsedActionAuthorisation, ParsedMapBlockchainPublicAddress, ParsedRegisterDomain, ParsedRemoveAllMappedAddresses, ParsedTransaction, ParsedTransferDomain, ParsedTransferFIOTokensData, Uint8_t, ValidBIP32Path} from "../../types/internal"
...
const CONTRACT_NAME = parseNameString("xferdomain", InvalidDataReason.UNEXPECTED_ERROR);


export function template_xferdomain(chainId: HexString, tx: ParsedTransaction, parsedPath: ValidBIP32Path): Array<Command> {
    ...
    const actionData: ParsedTransferDomain = tx.actions[0].data as ParsedTransferDomain;
    ...
    return [
        ...
        COMMAND_SHOW_MESSAGE("Action", "Transfer FIO Domain"),
        ...
        ...COMMANDS_COUNTED_SECTION([
            ...
            COMMAND_APPEND_DATA_STRING_WITH_LENGTH_SHOW("New owner Pubkey", Buffer.from(actionData.new_owner_fio_public_key)),
